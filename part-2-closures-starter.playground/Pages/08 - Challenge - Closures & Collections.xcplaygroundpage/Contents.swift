...
// map retorna um array, mas for each n

students.forEach { (student) in
    student.earnExtraCredit()
}
let classLibraryBooksMap = students.map { (student) -> [String] in
    student.libraryBooks
}

print(classLibraryBooksMap)
...
let classPets = students.compactMap { $0.pet}
/*:
 ## Challenge 3 - flatMap
...
*/
let classLibraryBooksFlatMap = students.flatMap { (student) -> [String] in
    student.libraryBooks
}

print(classLibraryBooksFlatMap)
